...
string *FileTable3 = ({
	...
	"/item/test2/NangCap/TC2",
	"/item/test2/NangCap/TC3",
//	"/item/final/16/1635",
//	"cash",
...
//		file = line[random(size)];
	/*	if (file=="cash")
		...
		{
		item = new ("/item/96/0404");
		}
		else if (file=="bikip2")
		{
		item = new ("/item/96/0405");
		}
		else if (file=="bikip3")
		{
		item = new ("/item/96/0104");
		}
		else	
		{		
			item = new (file);
