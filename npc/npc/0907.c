...
// 函数：获取人物造型
int get_char_picid() { return 9965; }

// 函数：构造处理
void create()
{
        set_name("Phục Lộ Ác Bá");
...
/*              else if( p < 6300 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 7200 * rate / 100 )    // 武器(门派)
                {
                       ...
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(95);  break;
                ...
                else if( p < 8100 * rate / 100 )    // 防具(门派)
                {
                       ...
                       case 1 : file = ARMOR_FILE->get_armor_file_2(95);  break;
                ...
                else if( p < 8500 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/quest/product2"->get_random_level_product(90,90);  break;
