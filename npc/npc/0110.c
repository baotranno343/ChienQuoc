...
void drop_items_callout(object me, object who)
{
        ...
        if (who->get_save_2("kiemtradanhanchua.score") == 1)
        {
                ...
                send_user(who, "%c%s", '!', sprintf("Đã giết được %d/20", who->get_save_2("soquaicandiet.score")));
                if (who->get_save_2("soquaicandiet.score") > 19)
                {
