...
void create()
{
        ...
        NPC_ENERGY_D->init_level( this_object(), 65+ random(5) );    // 
        set_max_seek(4);
...
/*              else if( p < 6300 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 7200 * rate / 100 )    // 武器(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = WEAPON_FILE->get_weapon_file_2(65);  break;
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(70);  break;
                       case 2 : file = WEAPON_FILE->get_weapon_file_2(75);  break;
                ...
                else if( p < 8100 * rate / 100 )    // 防具(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = ARMOR_FILE->get_armor_file_2(65);  break;
                       case 1 : file = ARMOR_FILE->get_armor_file_2(70);  break;
                       case 2 : file = ARMOR_FILE->get_armor_file_2(75);  break;
                ...
                else if( p < 8500 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/quest/product2"->get_random_level_blue_product(65,65);  break;
