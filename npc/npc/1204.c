...
// 函数：获取人物造型
int get_char_picid() { return 1221; }

// 函数：构造处理
void create()
{
        set_name("Địa Ngục Ác Tặc");
...
void drop_items_callout(object me, object who)
{
        ...
        {
                who->add_save_2("soquaicandiet11.score", 1);
                send_user(who, "%c%s", '!', sprintf("Đã giết được %d/20", who->get_save_2("soquaicandiet11.score")));
                if (who->get_save_2("soquaicandiet11.score") > 19)
                {
        ...
        for (i = 0; i < size; i++)
        {
                ...
                else if (p < 8940 * rate / 100) // 武器(门派)
                {
                        ...
                        {
                        case 0:
                                file = WEAPON_FILE->get_weapon_file_2(120);
                                break;
                        case 1:
                                file = WEAPON_FILE->get_weapon_file_2(120);
                                break;
                        case 2:
                                file = WEAPON_FILE->get_weapon_file_2(130);
                                break;
                ...
                else if (p < 9100 * rate / 100) // 防具(门派)
                {
                        ...
                        {
                        case 0:
                                file = ARMOR_FILE->get_armor_file_2(120);
                                break;
                        case 1:
                                file = ARMOR_FILE->get_armor_file_2(120);
                                break;
                        case 2:
                                file = ARMOR_FILE->get_armor_file_2(130);
                                break;
                ...
                else if (p < 9850 * rate / 100) // 杂物２
                {
                        ...
                        {
                        case 0:
                                file = "/item/stuff/0146";
                                break;
                        case 1:
                                file = "/item/stuff/0130";
                                break;
                        case 2:
                                file = "/item/stuff/0148";
                                break;
                        case 3:
                                file = "/item/stuff/0191";
                                break;
                        case 4:
