...
// 函数：获取人物造型
int get_char_picid() { return 1231; }

// 函数：构造处理
void create()
{
        set_name("Tôm Hùm Đông Hải");
...
void drop_items_callout(object me, object who)
{
        ...
        {
                who->add_save_2("soquaicandiet4.score", 1);
                send_user(who, "%c%s", '!', sprintf("Đã giết được %d/20", who->get_save_2("soquaicandiet4.score")));
                if (who->get_save_2("soquaicandiet4.score") > 19)
                {
        ...
        for (i = 0; i < size; i++)
        {
                ...
                else if (p < 8940 * rate / 100) // 武器(门派)
                {
                        ...
                        {
                        case 0:
                                file = WEAPON_FILE->get_weapon_file_2(55);
                                break;
                        case 1:
                ...
                else if (p < 9100 * rate / 100) // 防具(门派)
                {
                        ...
                        {
                        case 0:
                                file = ARMOR_FILE->get_armor_file_2(55);
                                break;
                        case 1:
