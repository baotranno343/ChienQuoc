...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 5034 * rate / 100 ) ;    // NONE

                else if( p < 5284 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 5284 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 9851 * rate / 100 )    // 杂物２
                {
                       ...
                       case 3 : file = "/item/32/3281";  break;
