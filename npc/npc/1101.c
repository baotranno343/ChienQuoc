...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 8364 * rate / 100 ) ;    // NONE

                else if( p < 9064 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 9100 * rate / 100 )    // 杂物１
                ...
                else if( p < 9850 * rate / 100 )    // 杂物２
                {
                       ...
                       case 2 : file = "/item/91/9135";  break;
