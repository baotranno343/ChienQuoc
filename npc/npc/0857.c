...
/*              else if( p < 6300 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 7200 * rate / 100 )    // 武器(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = WEAPON_FILE->get_weapon_file_2(85);  break;
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(90);  break;
                       case 2 : file = WEAPON_FILE->get_weapon_file_2(95);  break;
                ...
                else if( p < 8100 * rate / 100 )    // 防具(门派)
                {
                        ...
                        switch( random(3) )
                        {
                       case 0 : file = ARMOR_FILE->get_armor_file_2(85);  break;
                       case 1 : file = ARMOR_FILE->get_armor_file_2(90);  break;
                       case 2 : file = ARMOR_FILE->get_armor_file_2(95);  break;
                ...
                else if( p < 8500 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/quest/product2"->get_random_level_blue_product(85,85);  break;
