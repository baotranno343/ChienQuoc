...
void create()
{
        set_name("Tuần Thành Tiểu Binh");

        set_char_type(FIGHTER_TYPE);    // init_level 要用到
        
        set_head_color(0x0);

        NPC_ENERGY_D->init_level( this_object(), 25+ random(3) );    // 
        set_max_seek(4);
...
//      p = random(100);  size = ( p > 40 ) ? 3 : 10;  total = 2;  total2 = 3;
        ...
        for( i = 0; i < size; i ++ )
        {
                ...
                if( p < 4956 * rate / 100 ) ;    // NONE

                else if( p < 5206 * rate / 100 )    // 金钱
                {
...
/*              else if( p < 5206 * rate / 100 )    // 防具(基本)
                ...
                else if( p < 5277 * rate / 100 )    // 武器(门派)
                {
                       ...
                       case 1 : file = WEAPON_FILE->get_weapon_file_2(10);  break;
                ...
                else if( p < 5344 * rate / 100 )    // 防具(门派)
                {
                       ...
                       case 1 : file = ARMOR_FILE->get_armor_file_2(10);  break;
                ...
                else if( p < 9350 * rate / 100 )    // 杂物１
                {
                        switch( random(1) )
                        {
                       case 0 : file = "/item/40/4015";  break;
                ...
                else if( p < 9950 * rate / 100 )    // 杂物３
                {
                       ...
                       case 1 : file = "/item/41/4111";  break;
