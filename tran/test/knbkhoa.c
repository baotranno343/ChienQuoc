...
{
	return "Sử dụng sẽ nhận được 1000 KNB Khóa.";
}
...
int get_use_effect_callout(object who, object gift)
{
	...
	if (who->get_knbkhoa() > 100000)
	{
		send_user(who, "%c%s", '!', "KNB khóa của bạn đã hơn 10000");
		return 0;
	}
	//		TASK_LEGEND_D->check_task_item1(who,"Chén Bạc VIP",1);

	who->add_knbkhoa(10000);
	gift->add_amount(-1);
}