...
int main(object me, string arg)
{
        ...
        if (!objectp(who = find_char(arg)))
                return 1;
        // if (/*!who->is_seller() && */ who->is_seller() > 6999 && !who->is_seller_2() && !who->is_trader() && !who->is_store_open() && !who->is_bonus_seller() && !who->is_item_seller())
        //         return 1;
