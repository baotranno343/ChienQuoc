...
int get_item_value() { return 60; }
int get_item_value_2() { return 60; }

// 函数：构造处理
void create()
{
	set_name("Túi Hoàng Kim Tân Thủ cấp 30");
	set_picid_1(3102);
	set_picid_2(3102);
	set_value(100);
	//	set_save("knb",60);
...
{
	return "Sau khi sử dụng có thể nhận được một bộ trang bị Hoàng Kim cấp 30 tương ứng giới tính, môn phái.";
}
