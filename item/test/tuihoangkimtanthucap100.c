...
int get_item_value() { return 170; }
int get_item_value_2() { return 170; }

// 函数：构造处理
void create()
{
	set_name("Túi Hoàng Kim cấp 100");
	set_picid_1(3102);
	set_picid_2(3102);
	set_value(100);
	set_save("tbpt", 300);
...
{
	return "Sau khi sử dụng có thể nhận được một bộ trang bị Hoàng Kim cấp 100 tương ứng giới tính, môn phái.";
}
