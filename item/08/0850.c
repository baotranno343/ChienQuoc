...
string get_desc()
{
	return "Là linh thú đầu tiên trong 12 con Giáp, đại diện cho trí tuệ và sự\nthông minh. Sau khi triệu hồi sẽ tăng thêm năng lực của chủ nhân";
}
...
int get_use_effect_callout(object me, object item)
{
	...
	me->delete_2("shenshou");
	me->set_2("shenshou.dp", 150);
	me->set_2("shenshou.ap", 100);
	me->set_2("shenshou.pp", 150);
	me->set_2("shenshou.cp", 100);
	me->set_2("shenshou.hp", 200);
	me->set_2("shenshou.mp", 200);
