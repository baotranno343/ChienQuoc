...
string get_desc()
{
	return "Song Tử là 1 trong 12 cung Hoàng Đạo. Khi được triệu hồi, sẽ giúp chủ nhân gia tăng thêm 5% Ngoại Kháng, 5% Nội Kháng, 5% Khí Huyết.";
}
string get_short()
{
	return "Song Tử là 1 trong 12 cung Hoàng Đạo. Khi được triệu hồi, sẽ giúp chủ nhân gia tăng thêm 5% Ngoại Kháng, 5% Nội Kháng, 5% Khí Huyết, Thời gian giới hạn 14 ngày. nhận được sẽ tự phong ấn.";
}
// 函数：使用效果
...
int get_use_effect_callout(object me, object item)
{
	...
	me->set_2("jg_effect_buff.sz1", 30000);
