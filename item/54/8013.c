...
int get_item_number() {return 10001065 ;}
...
string get_desc() 
{ 
        return "Duy trì biến hình thành Hung Nô Mã Tặc trong vòng 1 tiếng, đồng thời nâng cao 2% Thân Thủ."; 
}
