...
string get_desc()
{
	return "Tiểu Quai vốn là Kỵ thú của nước Tề\n Điều kiện sử dụng: Người sử dụng phải trở thành dân của nước Tề hoặc đạt đủ Giao Hảo với nước Tề.\n Vật phẩm sau khi sử dụng sẽ Phong Ấn vào nhân vật.\n";
}
