...
string get_desc()
{
	return "Đà Đà vốn là Kỵ Thú của nước Triệu\n Điều kiện sử dụng: Người sử dụng phải trở thành dân của nước Triệu hoặc đạt đủ Giao Hảo với nước Triệu.\n Vật phẩm sau khi sử dụng sẽ Phong Ấn vào nhân vật.\n";
}
