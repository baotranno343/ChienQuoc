...
// 函数：获取描述
int get_item_value() {return 1250 ;}
int get_item_value_2() {return 1250 ;}
string get_desc() 
{ 
        return "Thú cưỡi có hình dạng của một loài Cá thần hiếm thấy trên thế gian.\n";
}
