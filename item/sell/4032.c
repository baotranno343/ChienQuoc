...
string get_desc()
{
	return HIY "Chỉ có thể luyện trang bị 6 sao trở lên. Giúp trang bị đạt trực tiếp cấp rèn tiếp theo.\n Có thể luyện tối đa 7 sao.";
}
...
int move_item_callout(object me, object item, object equip, int type)
{
	...
	if (level < 6)
	{
		notify("Đoạn Thạch Đặc Biệt chỉ rèn được trang bị 6 sao trở lên.");
		return 1;
	}
	if (level >= 7)
	{
