...
string get_desc()
{
	...
	string desc;
	desc = "Trang phục các nữ đại hiệp thường dùng, toát lên vẻ nghĩa hiệp không kém đấng mày râu. Khí Huyết +5 % , Phòng Thủ +5 %, Bạo Kích +2 % \n Nhấn chuột phải để sử dụng.";
...
int get_use_effect_callout(object me, object item)
{
	...
	me->set_save_2("marry_fashion.type", 3);
	...
	//me->set_save_2("marry_fashion.cl", 0xffffff
