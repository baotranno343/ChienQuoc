...
{
	return HIG "Đoạn Thạch Thuộc Huynh Đệ, phải hợp thành với Đoạn Thạch thường mới có thể lên Trung Cấp" NOR "\nChỉ Có thể rèn trang bị 1 ngôi sao hoặc thấp hơn, có thể tăng cường thuộc tính trang bị.\n Hai Sơ Cấp Đoạn Thạch có thể tạo thành một Trung Cấp Đoạn Thạch.";
}
