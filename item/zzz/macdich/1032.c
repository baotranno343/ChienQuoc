...
string get_desc()
{
	return HIG "Đoạn Thạch Thuộc Huynh Đệ, phải hợp thành với Đoạn Thạch thường mới có thể lên Cao Cấp" NOR "\nChỉ có thể luyện trong mức trang bị 2 hoặc 3 sao, có thể tăng cường thuộc tính của trang bị.\n Hai viên Trung Cấp Đoạn Thạch có thể hợp thành một viên Cao Cấp Đoạn Thạch.";
}
