...
string get_desc() 
{ 
        return "Có thể chứa đựng 50.000 điểm tiềm năng";
}
...
int get_use_effect_callout( object me, object item )
{
        ...
        {
                if( me->get_potential() < 50000 )
                {
                        send_user(me, "%c%s", '!', "Tiềm năng của bạn không đủ 50.000");
                        return 0;
                }
                me->add_potential( -50000 );
                item->set_potential(50000);
                write_user(me, "Bạn đem 50.000 tiềm năng cất vào %s.", item->get_name() );
