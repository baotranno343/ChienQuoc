...
#define TongBaoYeu "npc/event/tongbaoyeu2"
// cấp 10
void mot();
void hai();
void ba();
...
void drop_items(object me, object who)
{
	...
	if (random(2) == 0)
	{
		if (p = get_valid_xy(z, x, y, IS_ITEM_BLOCK))
		{
			item = new ("item/event/tuitongbao");
			TEAM_D->drop_item(item, who);
			item->set_user_id(owner);
			item->add_to_scene(z, p / 1000, p % 1000);
			item->set("winner", who);
...
void win_bonus_callout(object me, object who)
{
	...
	if (get_z(me) == 061)
	{
		call_out("check_mot", 900);
	}
	if (get_z(me) == 062)
	{
		call_out("check_hai", 900);
	}
	if (get_z(me) == 063)
	{
		call_out("check_ba", 900);
	}
	if (get_z(me) == 281)
	{
		call_out("check_bon", 900);
	}
	if (get_z(me) == 282)
	{
		call_out("check_nam", 900);
	}
	if (get_z(me) == 283)
	{
		call_out("check_sau", 900);
	}
	if (get_z(me) == 284)
	{
		call_out("check_bay", 900);
	}
	if (get_z(me) == 081)
	{
		call_out("check_mot_15", 900);
	}
	if (get_z(me) == 082)
	{
		call_out("check_hai_15", 900);
	}
	if (get_z(me) == 251)
	{
		call_out("check_ba_15", 900);
	}
	if (get_z(me) == 041)
	{
		call_out("check_mot_20", 900);
	}
	if (get_z(me) == 042)
	{
		call_out("check_hai_20", 900);
	}
	if (get_z(me) == 043)
	{
		call_out("check_ba_20", 900);
	}
	if (get_z(me) == 021)
	{
		call_out("check_bon_20", 900);
	}
	if (get_z(me) == 141)
	{
		call_out("check_nam_20", 900);
	}
	if (get_z(me) == 142)
	{
		call_out("check_sau_20", 900);
	}
	if (get_z(me) == 211)
	{
		call_out("check_bay_20", 900);
	}
	if (get_z(me) == 089)
	{
		call_out("check_mot_25", 900);
	}
	if (get_z(me) == 181)
	{
		call_out("check_hai_25", 900);
	}
	if (get_z(me) == 131)
	{
		call_out("check_ba_25", 900);
	}
	if (get_z(me) == 271)
	{
		call_out("check_bon_25", 900);
	}
	if (get_z(me) == 272)
	{
		call_out("check_nam_25", 900);
	}
	if (get_z(me) == 241)
	{
		call_out("check_sau_25", 900);
	}
	if (get_z(me) == 242)
	{
		call_out("check_bay_25", 900);
	}
	if (get_z(me) == 132)
	{
		call_out("check_tam_25", 900);
	}
	if (get_z(me) == 182)
	{
		call_out("check_chin_25", 900);
	}
	if (get_z(me) == 243)
	{
		call_out("check_muoi_25", 900);
	}
	if (get_z(me) == 155)
	{
		call_out("check_muoimot_25", 900);
	}
	if (get_z(me) == 231)
	{
		call_out("check_muoihai_25", 900);
	}
	if (get_z(me) == 163)
	{
		call_out("check_mot_30", 900);
	}
	if (get_z(me) == 164)
	{
		call_out("check_hai_30", 900);
	}
	if (get_z(me) == 261)
	{
		call_out("check_ba_30", 900);
	}
	if (get_z(me) == 262)
	{
		call_out("check_bon_30", 900);
	}
	if (get_z(me) == 263)
	{
		call_out("check_nam_30", 900);
	}
	if (get_z(me) == 264)
	{
		call_out("check_sau_30", 900);
	}
	if (get_z(me) == 265)
	{
		call_out("check_mot_35", 900);
	}
	if (get_z(me) == 266)
	{
		call_out("check_hai_35", 900);
	}
	if (get_z(me) == 111)
	{
		call_out("check_ba_35", 900);
	}
	if (get_z(me) == 112)
	{
		call_out("check_bon_35", 900);
	}
	if (get_z(me) == 011)
	{
		call_out("check_mot_40", 900);
	}
	if (get_z(me) == 012)
	{
		call_out("check_hai_40", 900);
	}
	if (get_z(me) == 013)
	{
		call_out("check_ba_40", 900);
	}
	if (get_z(me) == 014)
	{
		call_out("check_bon_40", 900);
	}
	if (get_z(me) == 015)
	{
		call_out("check_nam_40", 900);
	}
	if (get_z(me) == 151)
	{
		call_out("check_mot_45", 900);
	}
	if (get_z(me) == 152)
	{
		call_out("check_hai_45", 900);
	}
	if (get_z(me) == 153)
	{
		call_out("check_ba_45", 900);
	}
	if (get_z(me) == 171)
	{
		call_out("check_mot_50", 900);
	}
	if (get_z(me) == 172)
	{
		call_out("check_hai_50", 900);
	}
	if (get_z(me) == 173)
	{
		call_out("check_ba_50", 900);
	}
	if (get_z(me) == 174)
	{
		call_out("check_bon_50", 900);
	}
	if (get_z(me) == 071)
	{
		call_out("check_mot_55", 900);
	}
	if (get_z(me) == 072)
	{
		call_out("check_hai_55", 900);
	}
	if (get_z(me) == 073)
	{
		call_out("check_ba_55", 900);
	}
	if (get_z(me) == 031)
	{
		call_out("check_mot_60", 900);
	}
	if (get_z(me) == 032)
	{
		call_out("check_hai_60", 900);
	}
	if (get_z(me) == 033)
	{
		call_out("check_ba_60", 900);
	}
	...
	for (i = 0; i < size; i++)
		if (team[i])
		{
			...
			//	team[i]->add_cash(level*1000/size);
			//	write_user(team[i], sprintf(ECHO "Bạn tiêu diệt Chiến Quốc Tống Bảo Yêu nhận được %d Kinh nghiệm và %d Kim bảo, Ngan Luong!",exp2, (level*10/size)/10 ),(level*10000/size));
		}
}