...
// 函数：获取技能ID
int get_id() { return 74106; }
// 函数：获取技能类型
string get_name() { return "Miễn Nhiễm Hôn Mê"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, không bị lâm vào trạng thái hôn mê.";
}
// 函数：获取指令类型
