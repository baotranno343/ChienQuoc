...
// 函数：获取技能ID
int get_id() { return 74111; }
// 函数：获取技能类型
string get_name() { return "Miễn Nhiễm Choáng"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, không bị trúng trạng thái mê muội";
}
// 函数：获取指令类型
