...
#include <action.h>
#include <effect.h>
#define PF_START       "74130"
#define TIME_INTERVAL   5

// 函数：宠物技能
int is_pet_skill() { return 1; }
// 函数：获取技能ID
int get_id() { return 74130; }
// 函数：获取技能类型
string get_name() { return "Ác Sát"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, Sử dụng khiến tấn công bỏ qua 15% ngoại kháng mục tiêu, tái sử dụng sau 5 giây.";
}
// 函数：获取指令类型
...
int cast_done_npc( object me )
{
	...
	CHAR_FIGHT_D->attack_done(me, who, 0, 0, 0, 0, 15, 0 );
        me->set_enemy_3(who);
        set_heart_state(me, MAGIC_STAT);
