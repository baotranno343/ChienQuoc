...
// 函数：获取技能ID
int get_id() { return 74127; }
// 函数：获取技能类型
string get_name() { return "Suy Thần Phụ Thể"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, Khi công kích phòng thủ nhỏ nhất \nKhi bị công kích phòng thủ trở nên cực đại.";
}
// 函数：获取指令类型
