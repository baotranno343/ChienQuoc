...
#include <action.h>
#include <effect.h>
#define PF_START       "74234"
#define TIME_INTERVAL   20

// 函数：宠物技能
int is_pet_skill() { return 1; }
// 函数：获取技能ID
int get_id() { return 74234; }
// 函数：获取技能类型
string get_name() { return "Cao Cấp Thiên Cân"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, sử dụng có thể làm mục tiêu bị hôn mê 6 giây \nTái sử dụng sau 20 giây";
}
// 函数：获取指令类型
...
int cast_done_npc( object me )
{
	...
	set_effect(who, EFFECT_CHAR_FAINT, 6);
