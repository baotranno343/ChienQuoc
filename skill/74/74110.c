...
// 函数：获取技能ID
int get_id() { return 74110; }
// 函数：获取技能类型
string get_name() { return "Miễn Nhiễm Pháp Chú"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, không bị trúng nguyền rủa pháp thuật.";
}
// 函数：获取指令类型
