...
#include <action.h>
#include <effect.h>
#define PF_START       "74233"
#define TIME_INTERVAL   2

// 函数：宠物技能
int is_pet_skill() { return 1; }
// 函数：获取技能ID
int get_id() { return 74233; }
// 函数：获取技能类型
string get_name() { return "Cao Cấp Thiêu Đốt"; }
// 函数：获取技能类型（0、被动；1、主动）
...
{
	return HIC+get_name()+"\n Kỹ năng của Bảo thú, sử dụng có 30% tỷ lệ làm đối phương bị trạng thái thiêu đốt \nMỗi 2 giây rút 10 Khí Huyết \nDuy trì 20 giây.";
}
// 函数：获取指令类型
