...
string get_desc(object me)
{
        ...
        result = sprintf(HIC " %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n Vật phẩm tiêu hao: Trận Kì x1\n    Thiết lập trận pháp trong phạm vi 3x3 ô, Gây %d điểm sát thương thích ứng trong 4 giây tất cả mục tiêu lọt vào trận pháp.\n " HIC "Cấp tiếp theo:\n " NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng thêm %d sát thương nội công.",
                         PF_NAME, cur_level, SKILL_LEVEL, SUB_MP, TIME_INTERVAL, ((ADD_AP + me->get_cp()) * 2), cur_level * 10 + SKILL_LEVEL, (ADD_AP + me->get_cp()) + 15);
        return result;
}
