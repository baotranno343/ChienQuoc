...
#define PF_NAME "Tiên Nhân Chỉ Lộ"
...
string get_desc(object me)
{
        ...
        result = sprintf(HIC " %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Vận dụng nội công tạo thành tiên kiếm cường khí, Tăng %d sát thương 1 mục tiêu bất kì trong tầm nhìn.\n " HIC "Cấp tiếp theo:\n " NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng thêm %d sát thương.",
...
int cast_done(object me)
{
        ...
        CHAR_FIGHT_D->cast_done(me, who, ADD_AP * 5 / 2); // 小心准备 me
        if (who && !who->is_die())
