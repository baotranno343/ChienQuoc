...
#define THIS_PERFORM 02410
#define PF_START "02410"
#define PF_NAME "Mãng Xà Xuất Động"
...
string get_desc(object me)
{
        ...
        if (level < SKILL_LEVEL)
                return sprintf(HIR " %s \n Chiêu thức cận chiến sơ đẳng, tăng thêm 30 điểm Ngoại Công khi sát thương 1 mục tiêu.", PF_NAME);
        cur_level = (level - SKILL_LEVEL) / 10 + 1;
        result = sprintf(HIC " %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Nguyên khí tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n Chiêu thức cận chiến sơ đẳng, tăng thêm %d điểm Ngoại Công khi sát thương 1 mục tiêu.\n " HIC "Cấp tiếp theo:\n " NOR "Võ công yêu cầu: " HIR "Cấp %d \n" NOR " Tăng thêm %d điểm Ngoại Công.",
                         PF_NAME, cur_level, SKILL_LEVEL, SUB_YUAN, TIME_INTERVAL, ADD_AP, cur_level * 10 + SKILL_LEVEL, ADD_AP + 25);
        return result;
}
...
int main(object me, object who, int x, int y, string arg)
{
        ...
        if (!CHAR_FIGHT_D->attack_action(me, who, 1010, 1))
                return 1;
