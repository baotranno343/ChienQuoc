...
#define PF_NAME        "Liệt Phong Quyết"

#define SKILL_LEVEL     5
#define TIME_INTERVAL   1
#define SUB_MP          ( 8 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 4 )
#define ADD_AP          ( 35 + ( me->get_skill(THIS_SKILL)-SKILL_LEVEL) / 10 * 35 )
...
string get_desc( object me )
{
        ...
        result = sprintf(HIC" %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Pháp Lực tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n    Hô gọi liệt phong, tăng thêm %d điểm Nội Công khi tấn công 1 mục tiêu từ xa.\n " HIC"Cấp tiếp theo:\n "NOR "Võ công yêu cầu: " HIR "Cấp %d " NOR "\n    Tăng thêm %d điểm Nội Công.", 
