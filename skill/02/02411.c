...
#define PF_NAME "Giao Long Nhập Hải"

#define SKILL_LEVEL 6
#define TIME_INTERVAL 2
#define SUB_MP 0
#define SUB_YUAN 1
#define ADD_RATE 12 + (me->get_skill(THIS_SKILL) - SKILL_LEVEL) / 10 * 2
...
string get_desc(object me)
{
        ...
        if (level < SKILL_LEVEL)
                return sprintf(HIR " %s \n Võ công yêu cầu: Cấp 6\n Thương pháp như thuồng luồng về biển vừa quyết liệt vừa sắc bén, tăng thêm 12%% độ chính xác khi tấn công mục tiêu.", PF_NAME);
        cur_level = (level - SKILL_LEVEL) / 10 + 1;
        result = sprintf(HIC " %s (Cấp %d )\n " NOR "Võ công yêu cầu: Cấp %d \n Nguyên khí tiêu hao: %d điểm\n Tái sử dụng sau: %d giây\n Thương pháp như thuồng luồng về biển vừa quyết liệt vừa sắc bén, tăng thêm %d %% độ chính xác khi tấn công mục tiêu.\n " HIC "Cấp tiếp theo:\n " NOR "Võ công yêu cầu: " HIR "Cấp %d \n" NOR " Tăng thêm %d%% độ chính xác.",
