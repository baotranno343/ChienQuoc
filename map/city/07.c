...
#define SAVE_FILE "data/city/07" SAVE_EXTENSION
...
void load_zhou();
// 函数：获取地图标识
int get_map_id() { return 70; }

// 函数：获取城市名称
string get_name() { return "Yên Quốc"; }
...
// 函数：获取合法坐标
int get_xy_point(int flag) { return 070 * 1000000 + efun::get_xy_point(070, flag); }
