...
#define SAVE_FILE "data/city/03" SAVE_EXTENSION
...
void load_zhou();
// 函数：获取地图标识
int get_map_id() { return 30; }

// 函数：获取城市名称
string get_name() { return "Triệu Quốc"; }
...
// 函数：获取合法坐标
int get_xy_point(int flag) { return 030 * 1000000 + efun::get_xy_point(030, flag); }
...
void init_city()
{
        ...
        set_stability(7000);
        // set_disease();
        set_agriculture(25000);
        set_fishculture(5000);
        set_mining(18000);
        set_industry(25000);
        set_commercial(16000);
        set_arts(30000);
        set_education(26000);
        set_religion(23000);
