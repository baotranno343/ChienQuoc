...
#define SAVE_FILE "data/city/01" SAVE_EXTENSION
...
// 函数：获取城市名称
string get_name() { return "Tề Quốc"; }
...
// 函数：获取合法坐标
int get_xy_point(int flag) { return 010 * 1000000 + efun::get_xy_point(010, flag); }
...
void init_city()
{
        ...
        set_stability(9000);
        // set_disease();
        set_agriculture(24000);
        set_fishculture(25000);
        set_mining(10000);
        set_industry(20000);
        set_commercial(20000);
        set_arts(30000);
        set_education(26000);
        set_religion(25000);
