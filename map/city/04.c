...
#define SAVE_FILE "data/city/04" SAVE_EXTENSION
...
void load_zhou();
// 函数：获取地图标识
int get_map_id() { return 40; }

// 函数：获取城市名称
string get_name() { return "Ngụy Quốc"; }
...
// 函数：获取合法坐标
int get_xy_point(int flag) { return 040 * 1000000 + efun::get_xy_point(040, flag); }
...
void init_city()
{
        ...
        set_stability(8000);
        // set_disease();
        set_agriculture(20000);
        set_fishculture(5000);
        set_mining(18000);
        set_industry(20000);
        set_commercial(12000);
        set_arts(20000);
        set_education(19000);
        set_religion(20000);
